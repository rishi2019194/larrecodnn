...
class NuGraphApptainerInferenceTriton;
...
class NuGraphApptainerInferenceTriton : public art::EDProducer {
public:
  explicit NuGraphApptainerInferenceTriton(fhicl::ParameterSet const& p);

  // Plugins should not be copied or assigned.
  NuGraphApptainerInferenceTriton(NuGraphApptainerInferenceTriton const&) = delete;
  NuGraphApptainerInferenceTriton(NuGraphApptainerInferenceTriton&&) = delete;
  NuGraphApptainerInferenceTriton& operator=(NuGraphApptainerInferenceTriton const&) = delete;
  NuGraphApptainerInferenceTriton& operator=(NuGraphApptainerInferenceTriton&&) = delete;
...
NuGraphApptainerInferenceTriton::NuGraphApptainerInferenceTriton(fhicl::ParameterSet const& p)
  : EDProducer{p}
...
void NuGraphApptainerInferenceTriton::produce(art::Event& e)
{
...
DEFINE_ART_MODULE(NuGraphApptainerInferenceTriton)