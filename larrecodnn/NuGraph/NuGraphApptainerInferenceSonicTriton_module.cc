...
class NuGraphApptainerInferenceSonicTriton;
...
class NuGraphApptainerInferenceSonicTriton : public art::EDProducer {
public:
  explicit NuGraphApptainerInferenceSonicTriton(fhicl::ParameterSet const& p);

  // Plugins should not be copied or assigned.
  NuGraphApptainerInferenceSonicTriton(NuGraphApptainerInferenceSonicTriton const&) = delete;
  NuGraphApptainerInferenceSonicTriton(NuGraphApptainerInferenceSonicTriton&&) = delete;
  NuGraphApptainerInferenceSonicTriton& operator=(NuGraphApptainerInferenceSonicTriton const&) = delete;
  NuGraphApptainerInferenceSonicTriton& operator=(NuGraphApptainerInferenceSonicTriton&&) = delete;
...
NuGraphApptainerInferenceSonicTriton::NuGraphApptainerInferenceSonicTriton(fhicl::ParameterSet const& p)
  : EDProducer{p}
...
void NuGraphApptainerInferenceSonicTriton::produce(art::Event& e)
{
  ...
  std::string fTritonURL = "localhost:8001";
...
DEFINE_ART_MODULE(NuGraphApptainerInferenceSonicTriton)
